...
Although an implementation detail, I think it is something worth mentioning because it worked well and
saved time over the course of the project, is the classifier store. Through out the code base, classifiers were
not instantiated like regular objects, but instead requested in what I call the classifier store.
