...
8 classifier implementations available in scikit-learn\cite{scikit-learn} were individually evaluated using down-sampled data, and based on their performance  %todo which?
