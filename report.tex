...
The goal is for the produced summary to contain everything required to draw conclusions about opinions
and to enable future work to create interactive visualizations.

To acomplish this, three problems are introduced; Figure \ref{fig:overview} aims to give a
overview of how the problems relate to each other, this section will describe each problem briefly,
and subsequent chapters will then study each problem indivudually and in more detail. The remainder
of this chapter will introduce some definitions and theory shared by all chapters.
...
Chapter \ref{sec:aspect_grouping} introduces two methods, one supervised and one unsupervised, of grouping aspects into
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot table [x=r, y=p]{data/sent_trigram_pr.csv};
      \addplot table [x=r, y=p]{data/sent_interpol3_pr.csv};
      \legend{
        \ysc,
        Unigram ensemble,
        Bigram ensemble,
