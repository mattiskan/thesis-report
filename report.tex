...
Scikit-learn\ref{scikit-learn} is an open source machine learning toolkit which provides various
classifier implementations ready to use.
The precision of these classifiers were evaluated individually to make a decision on which classifier to use.

Early sentiment classification experiments combining these classifiers in ensamble compositions
where the mayority vote was chosen for classification showed promise, so an ensamble of the top performing
...
Results from this initial experiment can be seen in table
...
\begin{table}[h]
  ...
  \begin{tabular}{| c | c | c | c | c || c |}
    ...
    NaiveBayesClassifier& 0.611 & 0.509 & 0.589 & 0.636 & 0.586 \\
    LogisticRegression  & 0.648 & 0.545 & 0.607 & 0.436 & 0.559 \\
    SGDClassifier       & 0.611 & \textbf{0.655} & 0.554 & 0.455 & 0.568 \\
    SVC                 & 0.327 & 0.382 & 0.418 & \textbf{0.764} & 0.473 \\
    LinearSVC           & \textbf{0.759} & 0.582 & \textbf{0.679} & 0.582 & \textbf{0.650} \\
    MultinomialNB       & \textbf{0.759} & 0.600 & 0.661 & 0.473 & 0.623 \\
    BernoulliNB         & 0.400 & 0.455 & 0.582 & 0.509 & 0.486 \\
    \hline
    \emph{Ensamble}            & 0.648 & 0.582 & 0.571 & 0.582 & 0.595 \\ 
    \hline
...
\begin{table}[h]
  ...
  \begin{tabular}{| c | c | c | c | c || c |}
    \hline
    \textbf{Model} & Product & Value & Service & Establishment & \emph{Avg.} \\ \hline
    NaiveBayesClassifier& 0.127 & 0.255 & 0.255 & 0.800 & 0.359 \\
    LogisticRegression  & 0.218 & 0.255 & 0.200 & 0.709 & 0.345 \\
    SGDClassifier       & \textbf{0.855} & 0.255 & 0.236 & 0.164 & 0.377 \\
    SVC                 & 0.109 & 0.145 & 0.109 & \textbf{0.891} & 0.314 \\
    LinearSVC           & 0.291 & \textbf{0.273} & 0.236 & 0.836 & \textbf{0.409} \\
    MultinomialNB       & 0.255 & 0.236 & 0.255 & 0.727 & 0.368 \\
    BernoulliNB         & 0.093 & 0.255 & \textbf{0.268} & 0.800 & 0.355 \\
    \hline
    \emph{Ensamble}     & 0.182 & 0.200 & 0.291 & 0.818 & 0.373 \\
    \hline
%    \hline
  \end{tabular}
  \caption{Out-of-the-box \textbf{bigram} precision of classifiers included in Scikit-learn.
    Precision for individual classes varied greatly between measurements,
    a lot more than using unigram features,
    but the average had a standard deviation of less than 5\%
    between runs, so the preformance of the classifiers is to be considered stable.
