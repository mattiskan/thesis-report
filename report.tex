...
\begin{figure}[h]
  \centering
  \fbox{\includegraphics[width=12cm]{annontate_sentence.png}}
...
\begin{table}[ht]
  ...
  \pgfplotstabletypeset[
    ...
    columns/p/.style={precision=4, column type=l,column name=Precision},
...
\section{WordNet graph-search classifier}
\loremipsum
