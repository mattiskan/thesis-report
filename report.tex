...
Recall from the last chapter that aspects where yielded as noun phrases highly
probable to contain an opinion. To compare opinions on a more detailed level,
some attention has to be paid towards \emph{what} the opinion concerns.

If the opinion target is identified, comparisons for that target are made possible.
