...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \legend{biased unigram, unigram, bigram}
    \end{axis}
  \end{tikzpicture}
  \caption{Sentence classification performance based on data size}
  \label{data_size}
\end{figure}

Figure \ref {data_size} suggests
...
\begin{figure}[h]
  ...
  \begin{axis}[
    ...
    \legend{unigram, biased unigram, bigram, biased bigram}
  \end{axis}
  \end{tikzpicture}
...
\pagebreak
Figure \ref{percat} shows multiple interesting properties; first of all, comparison between
