...
WordNet \cite{miller1995wordnet} is an online lexical database designed for use under program control. RiTa \cite{howe2009rita} is an open source toolkit that amongst other things includes a library
