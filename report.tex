...
As the reader may very well be aware, other classification methods exist. Combining multiple
methods into one classifier is known as \emph{ensamble learning}.

, and could in theory improve classifications,
as different methods may consider different properties of data and may also be less likely to 
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot table [x=r, y=p]{data/sent_unigram.csv};
      \legend{
        \ysc,
        Unigram ensemble,
        Bigram ensemble,
