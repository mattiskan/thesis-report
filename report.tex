...
\chapter{Annotating sentences}

\begin{figure}[h]
  \centering
  \includegraphics[width=12cm]{annontate_sentence.png}
  \caption{Sentence annontations interface}
...
First of all, comparison between the balanced/unbalanced versions of the classifier models show that, as expected, there seems to be bias towards the more frequent $product$-class and respectively agains the infrequent $value$-class.
